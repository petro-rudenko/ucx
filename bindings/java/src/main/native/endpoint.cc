                                                             ...
                                                             jlong ep_ptr, jint mode)
{
    ...
    jobject jucx_request = allocate_jucx_request(env, NULL, &param);

    jclass jucx_request_cls = env->FindClass("org/openucx/jucx/ucp/UcpRequest");
    ...
    // allocate_jucx_request sets global reference to jucx_reqeust. But this is the only method
    // that doesn't have a callback - need to remove reference now.
...
{
    ucp_request_param_t param;
    jobject jucx_request = allocate_jucx_request(env, callback, &param);
                                                                    ...
                                                                    jobject callback, jint memory_type)
{
    ...
    set_jucx_request_iov(env, jucx_request, iovec);
